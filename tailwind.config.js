  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'fade-in-delay-1': 'fadeIn 0.8s cubic-bezier(0.4, 0, 0.2, 1) forwards 0.2s',
        'fade-in-delay-2': 'fadeIn 0.8s cubic-bezier(0.4, 0, 0.2, 1) forwards 0.4s',
        'fade-in-delay-3': 'fadeIn 0.8s cubic-bezier(0.4, 0, 0.2, 1) forwards 0.6s',
